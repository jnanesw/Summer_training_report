...
class Registration
{
	...
	void flights()
	{
		...
		switch(choice)
		{
			case 1:
				{
					cout<<"__________Welcome to the Dubai Emirates___________\n"<<endl;
			...
			case 2:
				{
					cout<<"__________Welcome to the Canadian Airlines___________\n"<<endl;
					cout<<"Following are the flights available\n"<<endl;
					cout<<"1.CA - 101"<<endl;
					cout<<"\t 06-07-2022 | 4:00 AM | 08 HRS | Rs.7500"<<endl;
					cout<<"2.CA - 201"<<endl;
			...
			case 3:
				{
					cout<<"__________Welcome to the UK Airways___________\n"<<endl;
					cout<<"Following are the flights available\n"<<endl;
					cout<<"1.UK - 401"<<endl;
					cout<<"\t 06-07-2022 | 4:00 AM | 08 HRS | Rs.7500"<<endl;
					cout<<"2.UK - 501"<<endl;
			...
			case 4:
				{
					cout<<"__________Welcome to the US Airways___________\n"<<endl;
					cout<<"Following are the flights available\n"<<endl;
					cout<<"1.US - 701"<<endl;
					cout<<"\t 06-07-2022 | 4:00 AM | 08 HRS | Rs.7500"<<endl;
					cout<<"2.US - 801"<<endl;
			...
			case 5:
				{
					cout<<"__________Welcome to the Australia Airways___________\n"<<endl;
					cout<<"Following are the flights available\n"<<endl;
					cout<<"1.UK - 1001"<<endl;
					cout<<"\t 06-07-2022 | 4:00 AM | 08 HRS | Rs.7500"<<endl;
					cout<<"2.CA - 2001"<<endl;
			...
			case 6:
				{
					cout<<"__________Welcome to the Europian Airways___________\n"<<endl;
					cout<<"Following are the flights available\n"<<endl;
					cout<<"1.EU - 4001"<<endl;
					cout<<"\t 06-07-2022 | 4:00 AM | 08 HRS | Rs.7500"<<endl;
					cout<<"2.EU - 5001"<<endl;
...
class Ticket : public Registration,public Details
{
	public:
		...
		void bill()
		{
			...
			{
				outf<<"__________TATA Airlines____________"<<endl;
				outf<<"__________Tickets_________________"<<endl;
...
void mainMenu()
{
	...
	switch(lchoice)
	{
		case 1:
		{
			cout<<"_________________Customers___________________"<<endl;
			d.information();
			cout<<"press any key to go back to main menu : "<<endl;
			cin>>back;
			if(back==1)
		...
		case 2:
		{
			cout<<"_______________Book a flight ticket_____________"<<endl;
			r.flights();
			break;
		}
		case 3:
		{
			cout<<"________________Get your ticket__________________"<<endl;
			t.bill();
